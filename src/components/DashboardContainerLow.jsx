    ...
    return (
        <div className="flex gap-6 p-6 bg-[#FAFAFA] min-h-item">
            ...
            <div className="w-[45%] rounded-xl shadow-lg p-6 bg-[#56AB92]">
                ...
                <h2 className="!text-[#FAFAFA] !text-4xl !font-bold mt-2">Deliver a 5 Star Guest Experience</h2>
                <p className="mt-2 text-[#FAFAFA] text-xl font-normal">
            ...
            {/* Finance Card */}
            <div className="w-[55%] bg-white rounded-xl shadow-lg p-6">
                <div className="flex items-center gap-2 text-gray-500 font-semibold">
                    <Wallet className="w-5 h-5" />
                    <span>FINANCE AND RECONCILIATION</span>
                </div>
                <h2 className="text-3xl font-bold mt-2">Simplify Your <span className="text-[#56AB92]">Restaurant's Finances</span></h2>
